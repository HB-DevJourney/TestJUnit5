...
class CadastroEditorComStubTest {
    ...
    @BeforeEach
    void beforeEach() {
        editor = new Editor("Mateus", "mateus.@email.com", BigDecimal.TEN, true);
    ...
    @Test
    public void Dado_um_editor_null_Qaundo_criar_Entao_deve_retornar_exception() {
    ...
    void Dado_um_editor_com_email_existente_Quando_criar_Entao_deve_lancar_exception() {
        editor.setEmail("mateus@email.com");
